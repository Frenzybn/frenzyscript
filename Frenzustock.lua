...
OrionLib:MakeNotification({
	Name = "Discord server",
	Content = "https://discord.gg/frenzyhubs",
	Image = "rbxassetid://119980140458596",
	Time = 25
})
...
if World2 and World1 then
    ...
    M:AddParagraph("Redeem Code","Click to Button to Redeem All Code In Blox Fruits.")
...
elseif World3 then
	tableBoss = {"Raid Boss [Lv. 3000]","Stone","Island Empress","Kilo Admiral","Captain Elephant","Beautiful Pirate","rip_indra True Form","Longma","Soul Reaper","Cake Queen"}
end
...
AutoPullLever = R:AddToggle({
    Name = "Auto Pull Level",
    Default = false,
    Flag = "Auto Pull Level",
    Save = true,
    Callback = function(Value)
    ...
    while wait() do
        if _G.AutoEliteHunter then
            if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                ...
                OrionLib:MakeNotification({
                    Name = "Frenzy Hub(Noitification)",
                    Content = "[MN] : Farm level даалгавар цуцална уу (хэрэв байгаа бол)",
                    Image = "rbxassetid://4483345998",
                    Time = 9
                })
            end
